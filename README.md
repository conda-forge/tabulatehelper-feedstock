About tabulatehelper-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tabulatehelper-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/kiwi0fruit/tabulatehelper

Documentation: https://github.com/kiwi0fruit/tabulatehelper
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6093&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tabulatehelper-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tabulatehelper` can be installed with `conda`:
...
```
mamba install tabulatehelper
```

It is possible to list all of the versions of `tabulatehelper` available on your platform with `conda`:
...
```
mamba search tabulatehelper --channel conda-forge
```
...
mamba repoquery search tabulatehelper --channel conda-forge

# List packages depending on `tabulatehelper`:
mamba repoquery whoneeds tabulatehelper --channel conda-forge

# List dependencies of `tabulatehelper`:
mamba repoquery depends tabulatehelper --channel conda-forge
```
